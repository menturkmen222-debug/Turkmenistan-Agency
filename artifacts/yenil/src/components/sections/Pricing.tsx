...
function PricingModal({ tier, onClose }: ModalProps) {
  ...
  const content = tier === 'starter' ? {
    ...
    badge: "Starter — $199",
    points: [
      { icon: "✅", text: "1 sahypa Landing Page — ýokary hilli kod" },
      { icon: "✅", text: "Mobil laýyk (responsive) dizaýn" },
      { icon: "✅", text: "Teiz açylýan optimizasiýa edilen sahypa" },
      { icon: "✅", text: "Gözleg motory (Google/Yandex) üçin SEO" },
      { icon: "✅", text: "1 aý tehniki goldaw" },
      { icon: "⚠️", text: "Domen we Hosting bu baha degişli däl" },
    ],
    note: "Domen we Hosting bu baha degişli däl.",
    elif: "Biz size iň gowy saýty gurup berýäris, emma saýtyň ady we internetdaky ýeri üçin aýratyn töleg etmeli bolarsyňyz.",
    vision: "Domen — 3 bilen 10 ýyl aralygynda markaňyzyň sanly dünýädäki ady. Ol biziň hyzmaty däl, ol siziň maýaňyz.",
    why: "Bu baha — dünýä derejesindäki kod we dizaýn üçin. Arzan saýtlar wagtyňyzy we müşderileriňizi ýitirer; biz bolsa size gazanç getirýän gural gurýarys.",
  } : {
    headline: "Hemme Zat Taýýar",
    badge: "Pro E-Commerce — $599",
    points: [
      { icon: "✅", text: "5-10 sahypa doly saýt" },
      { icon: "✅", text: "Özboluşly premium dizaýn" },
      { icon: "✅", text: "E-Commerce: onlaýn söwda ulgamy" },
      { icon: "🎁", text: "3 ýyllyk MUGT domen!" },
      { icon: "🎁", text: "Professional Logo dizaýny — SOWGAT!" },
      { icon: "✅", text: "Hosting goşulan (aýratyn töleg ýok)" },
      { icon: "✅", text: "Google/Yandex indeksirleme" },
      { icon: "✅", text: "AI Chat integrasiýasy" },
      { icon: "✅", text: "CMS: özüňiz üýtgedip bilersiňiz" },
      { icon: "✅", text: "3 aý tehniki goldaw" },
    ],
    note: "Hemme zat içinde: domen + hosting + logo + AI. Goşmaça töleg ýok.",
    elif: "Size açary eline berlen taýýar biznes saýtyny hödürleýäris. Hiç hili goşmaça töleg gerek däl.",
    vision: "Ilkinji günden satmaga taýýar professional biznes ulgamy. Müşderileňiz awtomatiki gelýär.",
    why: "Bu diňe bir saýt däl, eýsem awtomatlaşdyrylan biznes ulgamy. Domen we Logo sowgat bermek bilen, biz siziň işiňizi nol wezipeden profesiýonal derejä çykarýarys.",
  };
